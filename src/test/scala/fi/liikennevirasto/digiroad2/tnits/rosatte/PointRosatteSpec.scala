...
class PointRosatteSpec extends FunSuite {
  ...
  test("Simple conversion") {
    ...
    val parsed = (parse(input) \ "features").extract[Seq[FeaturePoint[PedestrianCrossingProperties]]].asInstanceOf[Seq[Feature[AssetProperties]]]
  ...
  test("Simple conversion with simple value") {
    val input =
      """{
        "type": "FeatureCollection",
        "features": [
          ...
          <rst:GenericSafetyFeature gml:id="ID-FOO">
            ...
            <rst:properties>
              <rst:SafetyFeaturePropertyValue>
                <rst:type>WarningSignType</rst:type>
                <rst:propertyValue>DangerousCurve</rst:propertyValue>
              </rst:SafetyFeaturePropertyValue>
            </rst:properties>
          </rst:GenericSafetyFeature>
        </gml:featureMember><rst:metadata>
  ...
  test("Simple conversion with unknown sideCode") {
    val input =
      """{
        "type": "FeatureCollection",
        "features": [
